...
#[Route('/showDBauthor', name: 'showDBauthor')]
    ...
    #[Route('/addstatisticauthor', name: 'addstatisticauthor')]
    public function addstatisticauthor(ManagerRegistry $managerRegistry): Response
    {
        $em=$managerRegistry->getManager();
        $author= new Author();
        $author->setUsername("sarra bouden");
        $author->setEmail("3a58@gmail.com");
        $author->setNbBooks(55);
        $em->persist($author);
        $em->flush();
